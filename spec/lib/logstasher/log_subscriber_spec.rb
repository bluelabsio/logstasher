...
describe LogStasher::RequestLogSubscriber do
  ...
  describe '.process_action' do
    ...
    let(:logger)  { double }
    let(:json)    { "{\"request\":true,\"status\":true,\"runtimes\":true,\"location\":true,\"exception\":true,\"custom\":true,\"source\":\"unknown\",\"tags\":[\"request\"],\"@timestamp\":\"1970-01-01T00:00:00Z\",\"@version\":\"1\"}\n" }
    before do
